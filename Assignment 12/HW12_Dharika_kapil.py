...
def students_summary()->str:   
    query:str="select s.Name as Name,s.CWID as CWID,g.Course as Course,g.Grade as Grade,i.Name as InstructorName from students s join grades g on s.CWID=g.StudentCWID join instructors i on g.InstructorCWID=i.CWID order by s.Name ASC"
